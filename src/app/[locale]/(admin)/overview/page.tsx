  ...
  return (
    <div className="space-y-10 pb-20">
      <header className="space-y-1">
        ...
        <p className="text-muted-foreground">Monitor aktivitas seluruh platform Ajar.</p>
      </header>
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <article className="rounded-2xl border bg-card p-6 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <div>
               <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Enrollments</p>
      ...
      <div className="grid gap-10 lg:grid-cols-2">
         <section className="rounded-2xl border bg-card/50 p-8 shadow-sm backdrop-blur-xl">
            <h2 className="mb-6 text-xl font-black uppercase tracking-tight flex items-center gap-3">
               <Users className="size-5 text-blue-500" /> User Terbaru
            </h2>
         ...
         <section className="rounded-2xl border bg-card/50 p-8 shadow-sm backdrop-blur-xl">
            <h2 className="mb-6 text-xl font-black uppercase tracking-tight flex items-center gap-3">
               <BookOpen className="size-5 text-emerald-500" /> Kursus Terbaru
            </h2>
            <div className="space-y-4">
               {recentCourses.map((course) => (
                 <div key={course.id} className="flex items-center justify-between rounded-2xl bg-background/50 p-4">
                    <div className="flex items-center gap-3">
                       <div className="size-10 overflow-hidden rounded-xl bg-muted">
                          {course.thumbnail && <img src={course.thumbnail} alt={course.titleId} className="h-full w-full object-cover" />}
                       </div>
                       <div className="max-w-[150px] sm:max-w-[200px]">
                          <p className="truncate text-sm font-bold">{course.titleId}</p>
