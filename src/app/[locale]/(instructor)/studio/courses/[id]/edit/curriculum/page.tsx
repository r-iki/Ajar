    ...
    <div className="space-y-10">
      <header className="flex items-center justify-between">
        <div className="space-y-1">
           <h2 className="text-xl font-black uppercase tracking-tight">Kurikulum Kursus</h2>
           <p className="text-xs text-muted-foreground font-medium">Susun modul dan materi pembelajaran Anda.</p>
        </div>
      </header>
