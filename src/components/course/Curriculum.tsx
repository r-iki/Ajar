          ...
          <div key={module.id} className="group">
            ...
            >
              <div className="space-y-1">
                ...
                <h3 className="text-lg font-bold">{tDb(module.title, locale)}</h3>
              </div>
                ...
                {module.lessons.map((lesson) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-medium group-hover/lesson:text-primary transition-colors">{tDb(lesson.title, locale)}</span>
                    </div>
